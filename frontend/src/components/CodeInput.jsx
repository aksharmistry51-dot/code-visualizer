    ...
    <div className="bg-gray-950 rounded-lg">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-900 rounded-t-lg">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-3 text-gray-500 font-mono text-xs uppercase tracking-widest">
            {language === 'Python' ? 'main.py' : language === 'Java' ? 'Main.java' : 'main.js'}
          </span>
        </div>
        <span className="text-blue-600 font-mono text-xs">{language || 'JavaScript'}</span>
      </div>
      <div className="flex">
